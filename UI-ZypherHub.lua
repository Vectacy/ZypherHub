...
ScreenGui.Parent = game:GetService("CoreGui")
    ...
    closeLib.MouseButton1Click:Connect(function()
        ...
        if isClosed then
            ...
            game:GetService("TweenService"):Create(closeLib, TweenInfo.new(0.10, Enum.EasingStyle.Quad, Enum.EasingDirection.In),{
                Rotation = 360
            }):Play()
            MainWhiteFrame:TweenSize(UDim2.new(0, 424,0, 58), "In", "Linear", 0.12)
            game:GetService("TweenService"):Create(MainWhiteFrame_2, TweenInfo.new(0.10, Enum.EasingStyle.Quad, Enum.EasingDirection.In),{
                BackgroundTransparency = 1
            }):Play()
            game:GetService("TweenService"):Create(MainWhiteFrame, TweenInfo.new(0.10, Enum.EasingStyle.Quad, Enum.EasingDirection.In),{
                BackgroundTransparency = 1
            }):Play()
        else
            closeLib.Image = "rbxassetid://4988112250"
    ...
    function SectionHandler:CreateSection(secName)
        ...
        local function UpdateSize()
            ...
            game:GetService("TweenService"):Create(newPage, TweenInfo.new(0.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
        ...
        tabBtn.MouseButton1Click:Connect(function()
            ...
            for i,v in next, tabFrame:GetChildren() do
                if v:IsA("TextButton") then
                    UpdateSize()
                    game:GetService("TweenService"):Create(v, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),{
                        BackgroundColor3 = Color3.fromRGB(25,25,25)
                    }):Play()
                end
            end
            game:GetService("TweenService"):Create(tabBtn, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),{
        ...
        function ElementHandler:TextButton(buttonText, buttonInfo, callback)
            ...
            function ElementHandler:Toggle(togInfo, callback)
                ...
                toggleBtn.MouseButton1Click:Connect(function()
                    ...
                    callback(toggled)
                    if toggled then
                        game:GetService("TweenService"):Create(toggleBtn, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),{
                ...
                function ElementHandler:Slider(sliderin, minvalue, maxvalue, callback)
                    ...
                    local mouse = (game:GetService('Players').LocalPlayer and game:GetService('Players').LocalPlayer:GetMouse())
                                ...
                                function ElementHandler:Dropdown(dInfo, list, callback)
                                    ...
                                    ImageButton.MouseButton1Click:Connect(function()
                                        if isDropped then
                                            ...
                                            game:GetService("TweenService"):Create(ImageButton, TweenInfo.new(0.10, Enum.EasingStyle.Quad, Enum.EasingDirection.In),{
                                                Rotation = 0
                                            }):Play()
                                            wait(0.10)
                                            UpdateSize()
